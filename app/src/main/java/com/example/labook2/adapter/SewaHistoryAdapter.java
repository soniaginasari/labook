...
public class SewaHistoryAdapter extends RecyclerView.Adapter<SewaHistoryAdapter.MyViewHolder> {

    List<SewaItem> my_list;
    List<SewaItem> my_listfull;
    Context context;

    public SewaHistoryAdapter(Context context, List<SewaItem> my_list) {
...
//        SimpleDateFormat sdfBulanTahun = new SimpleDateFormat(formatBulanTahun);
        ...
        Log.i("ket", model.getKet_pembayaran());
