...
public class SewaItem {
    ...
    @SerializedName("file_selesai")
    private String file_selesai;
    ...
    public void setFile_selesai(String file_selesai){
        this.file_selesai = file_selesai;
    }

    public String getFile_selesai(){
        return file_selesai;
    }
