...
public class VerifBidangFragment extends Fragment {
    ...
    public VerifBidangFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static VerifBidangFragment newInstance() {
        VerifBidangFragment fragment = new VerifBidangFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_verif_bidang, container, false);
    ...
    private void getResult() {
        mApiService.getVerifBidang(id_laboratorium).enqueue(new Callback<ResponseVerifLaboran>() {
            @Override
