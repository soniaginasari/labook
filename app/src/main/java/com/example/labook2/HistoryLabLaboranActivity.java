...
public class HistoryLabLaboranActivity extends AppCompatActivity {
    ...
    Context mContext;
    String id_laboran, keterangan;
    Preferences sharedPrefManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_history_lab_laboran);


//        View myView = inflater.inflate(R.layout.fragment_home, container, false);
        recyclerView = findViewById(R.id.recyclerView);
        sharedPrefManager = new Preferences(HistoryLabLaboranActivity.this.getApplicationContext());
    ...
    private void getHistory() {
        mApiService.getSewaLaboranHistory(id_laboran,keterangan).enqueue(new Callback<ResponseSewa>() {
            @Override
