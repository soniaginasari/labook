 ...
 * Use the {@link VerifLayananFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class VerifLayananFragment extends Fragment {
    ...
    public VerifLayananFragment() {
        // Required empty public constructor
    }

    public static VerifLayananFragment newInstance() {
        VerifLayananFragment fragment = new VerifLayananFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_verif_layanan, container, false);
    ...
    private void getResult() {
        mApiService.getVerifLayanan(id_laboratorium).enqueue(new Callback<ResponseVerifLaboran>() {
            @Override
